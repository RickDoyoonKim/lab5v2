...
namespace lab5.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            ViewBag.ProvinceCode = new SelectList(db.Province, "ProvinceCode", "ProvinceName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "CityId,CityName,Population,ProvinceCode")] City city)
        {
            ...
            ViewBag.ProvinceCode = new SelectList(db.Province, "ProvinceCode", "ProvinceName", city.ProvinceCode);
            return View(city);
        }
